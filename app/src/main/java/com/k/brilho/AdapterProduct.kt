...
class AdapterProduct(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val dir = File(currentItem.image!!)
        if (dir.exists()) {
            val bitmap = BitmapFactory.decodeFile(dir.absolutePath)
        ...
        // image.setImageURI(Uri.fromFile(dir))
       /*  Glide.with(contextContent!!)
        ...
        if (allProducts) {
            ...
            add.setOnClickListener {
                ...
                (contextContent as ProductActivity).addToCar(it.tag as Int)
            }
        } else {
